...
Resolution: see commit on the `feature/person-tag-regex-refinement` branch (squash-merged), and `docs/session_logs/2026-05-20_person_tag_regex_refinement.md`. Audit context preserved at `docs/person_tag_audit_2026-05-19.md` (not modified by this PR).
