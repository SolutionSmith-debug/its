...
>   - The daemon plane — liveness, breaker, alerts, row-cap, picklists, guards → Guard sweeps — blueprint symlinks + token write-capability → “The Smartsheet token can no longer write.”
