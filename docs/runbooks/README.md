...
|------|------|--------|------------|-------|-----|
| 2026-07-19 | operations | active | _–_ | [Runbook — Vendor-estimate importer (`estimate_poll`) (an uploaded estimate stuck / refused / dark) (Successor-Remediation, Op Stds §43)](estimate_import_path.md) | _–_ |
