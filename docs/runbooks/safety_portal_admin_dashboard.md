...
>   - Safety report — portal submission to sent weekly packet → Field user submits the form in the portal → “The portal rejects the submission or the user is bounced to login.”
<!-- END TREE-XREF -->
