...
1. **Tier 1 — self-heal.** Interval daemons recover via launchd re-invocation (one-shot-per-
   ...
   all 13 tracked jobs (`TRACKED_JOBS`); the external UptimeRobot ping (audit F16) is the dead-man's switch for
