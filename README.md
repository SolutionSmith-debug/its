...
(canonical pattern per Op Stds v13 §31). Shortcuts for manual operator-triggered jobs.
...
specifications (Foundation Mission v8, Operational Standards v13).
